                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> <?php echo e($milks->farmer_id); ?> </td>
                          <td> 
                            <?php
                            if($milks->quality < 10){
                              ?>
                              Low Somatic Counts - <?php echo e($milks->quality); ?>%
                            <?php
                            }else{
                            ?>
Low Bacteria Counts - <?php echo e($milks->quality); ?>%
                            <?php
                            }
                            ?></td>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="<?php echo e(url('/storeMilks')); ?>">
                      <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/admin/milk.blade.php ENDPATH**/ ?>