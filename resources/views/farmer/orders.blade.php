                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          ?>
                          <td> <a href="{{ url('cancelOrder',$morder->id) }}" class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Cancel This Order ?')">CANCEL</a></td> 
<?php
}
                        ?>
                        </tr>
