          ...
          <div class="content-wrapper">
            ...
            <div class="row" id="dash">
              <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">My Orders(s) </h4>
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <?php $__currentLoopData = $myorders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $morder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <td> <?php echo e($morder->id); ?> </td>
                          ...
                          <?php $__currentLoopData = $contactDet1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                      
                          <td> <?php echo e($cd->name); ?> & <br><?php echo e($cd->phone_number); ?> or <br><?php echo e($cd->email); ?></td>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <td> <?php echo e($morder->order_price); ?> </td> 
                          <td> <?php echo e($morder->Status); ?> </td>  
                                                    <?php 
                          ...
                          ?>
                          <td> <a href="<?php echo e(url('cancelOrder',$morder->id)); ?>" class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Cancel This Order ?')">CANCEL</a></td> 
<?php
}
                        ?>
                        </tr>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <td></td>
                          <td></td>
                          <td><?php echo e($myorders->sum('order_price')); ?></td>
                         </tr>
                      </tbody>
                    </table>
                  </div>
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/farmer/orders.blade.php ENDPATH**/ ?>