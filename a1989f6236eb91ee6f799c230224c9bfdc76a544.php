          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> <a href="<?php echo e(url('/home')); ?>" style="color: black;text-decoration: none;">Dashboard</a> / Order(s) 
              </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <?php $__currentLoopData = $otherorders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oorder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <td> <?php echo e($oorder->id); ?> </td>
                          <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                      
                          <td> <?php echo e($exs->id); ?> </td>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php $__currentLoopData = $contactDet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                      
                          <td> <?php echo e($cd->name); ?> & <br><?php echo e($cd->phone_number); ?> or <br><?php echo e($cd->email); ?></td>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <td> <?php echo e($oorder->order_price); ?> </td> 
                          <td> <?php echo e($oorder->Status); ?> </td> 
                          <?php 
                          ...
                          ?>
                          <td> <a href="<?php echo e(url('completeOrder',$oorder->id)); ?>" class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Complete This Order ?')">COMPLETE</a></td> 
                          <?php
                        }else if($oorder->Status == "Active"){
                          ?>
                          <td> <a href="<?php echo e(url('acceptOrder',$oorder->id)); ?>" class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Accept This Order ?')">ACCEPT</a></td>
                          <td> <a href="<?php echo e(url('denyOrder',$oorder->id)); ?>" class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Deny This Order ?')">DENY</a></td> 
                          <?php
                        }
                        ?>
                        </tr>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <td></td>
                          <td></td>
                          <td><?php echo e($otherorders->sum('order_price')); ?></td>
                         </tr>
                      </tbody>
                    </table>
                  </div>
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/admin/orders.blade.php ENDPATH**/ ?>