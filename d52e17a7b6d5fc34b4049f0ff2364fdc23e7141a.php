                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn hvr-hover" href="<?php echo e(route('login')); ?>">Login</a></p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form id="" action="<?php echo e(url('add_user')); ?>" enctype="multipart/form-data" onsubmit="return validateForm();" method="POST" name="">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-12">
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/users/home.blade.php ENDPATH**/ ?>