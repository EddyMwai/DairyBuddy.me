...
Route::get('completeOrder/{id}/', [AdminController::class, 'completeOrders']);
Route::get('acceptOrder/{id}/', [AdminController::class, 'acceptOrders']);
Route::get('denyOrder/{id}/', [AdminController::class, 'denyOrders']);
