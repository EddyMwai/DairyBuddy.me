...
<!--     <script src="assets/js/dashboard.js"></script>
    ...
    <!-- End custom js for this page -->
        ...
        $(document).ready(function() {
            var orders = <?php echo json_encode($orders, 15, 512) ?>;
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/farmer/statistics.blade.php ENDPATH**/ ?>