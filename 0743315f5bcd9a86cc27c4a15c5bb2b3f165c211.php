                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><form action="<?php echo e(route('cart.add')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="product_or_service_id" value="<?php echo e($exs->id); ?>">
                            <input type="hidden" name="product_type" value="Extension Service">
                            <input type="hidden" name="payable_amount" value="<?php echo e($exs->payable_amount); ?>" required>
                            <input type="hidden" name="quantity" value="1" min="1" class="form-control" style="width: 80px;">
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/farmer/exs.blade.php ENDPATH**/ ?>