...
<head>
    ...
    <title>Dairy Buddy - Farmer Cart Page</title>
    <!-- plugins:css -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($item->farmer_id); ?></td>
                                    <td><?php echo e($item->product_or_service_id); ?></td>
                                    <td><?php echo e($item->product_type); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('cart.updateQuantity', $item->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <input type="number" name="quantity" value="<?php echo e($item->quantity); ?>" min="1" class="form-control" style="width: 80px; display: inline-block;">
...
</html><?php /**PATH D:\Documents\Strathmore University\Systems\Current\Milk Production Management\Milk_Production_Management\resources\views/farmer/cart.blade.php ENDPATH**/ ?>